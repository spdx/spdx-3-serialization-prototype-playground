## [VexNotAffectedVulnAssessmentRelationship](https://github.com/spdx/spdx-3-model/blob/main/model/Security/Classes/VexNotAffectedVulnAssessmentRelationship.md)
...
class VexNotAffectedVulnAssessmentRelationship(VexVulnAssessmentRelationship):
    ...
    impactStatement: String = None                     # * optional 
